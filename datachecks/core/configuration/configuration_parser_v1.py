...
def load_configuration_from_yaml_str(
    ...
    if configuration:
        if configuration.data_sources:
            configuration.data_sources.update(from_dict.data_sources)
        else:
            configuration.data_sources = from_dict.data_sources
        if configuration.validations:
            configuration.validations.update(from_dict.validations)
        else:
            configuration.validations = from_dict.validations
    return from_dict
